...
(0, _jquery2.default)(document).ready(function () {
	...
	var $tvShowContainer = (0, _jquery2.default)('#app-body').find('.tv-shows');
	...
	function renderShow(shows) {
		...
		shows.forEach(function (show) {
			...
			$tvShowContainer.append((0, _jquery2.default)(article));
		});
	}
	/**
 submit serach form
 */
	(0, _jquery2.default)('#app-body').find('form').submit(function (ev) {
		...
		(0, _jquery2.default)('<div class="loader">').appendTo('tvShowContainer');
